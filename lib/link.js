...
exports.hasRelationType = hasRelationType;
exports.format = linkFormat;
...
/*
 * Format Link headers as per RFC 5988
 */
function linkFormat(obj) {
  var str = '<';
  if(obj.href) {
    str += obj.href;
  }
...
/*
 * Parse Link headers as per RFC 5988
 */
...
/*
 * Check if the link has a given relation type
 */
function hasRelationType(link, type) {
  if(link.rel == undefined) return false;
  for(var t in link.rel) {
    if(link.rel[t] == type) {
      return true;
    }
  }
